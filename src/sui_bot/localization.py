...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "use_links": "💡 Use this link in V2rayNG or similar apps.",
    ...
    "fa": {
        ...
        "welcome": "🤖 به ربات Vpnfiy خوش آمدید\n\nیک گزینه را انتخاب کنید:",
        "shop_menu": "🛍️ خرید اشتراک",
        ...
        "support": "🆘 پشتیبانی", "support_title": "🆘 ارتباط با پشتیبانی",
        ...
        "subscription_links": "🔗 لینک‌های اشتراک شما",         "use_links": "💡 این لینک را در V2rayNG یا اپ‌های مشابه استفاده کنید.",
    ...
    "ru": {
        "choose_language": "🌐 Выберите предпочитаемый язык:", "language_saved": "✅ Язык сохранён.", "shop_menu": "🛍️ Купить подписку",
    ...
    "zh": {
        "choose_language": "🌐 请选择您的首选语言：", "language_saved": "✅ 语言已保存。", "shop_menu": "🛍️ 购买订阅",
